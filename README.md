...
[![Profile Views](https://komarev.com/ghpvc/?username=tanzilhasan5&label=Profile%20Views&color=0e75b6&style=flat)](https://github.com/tanzilhasan5)
[![Email](https://img.shields.io/badge/Email-tanzilhasan151@gmail.com-D14836?style=flat&logo=gmail&logoColor=white)](mailto:tanzilhasan151@gmail.com)
...
- 🔭 **Currently building:**
  - `Stovetop Radio` — Music streaming app
  - `AquaFlow` — AI-powered insurance assistant
  - [`Angry_GPT`](https://github.com/tanzilhasan5/Angry_GPT) *(seeking contributors)*

- 🌱 **Currently deepening my skills in:**
  Flutter · Dart · Firebase (Auth, FCM, Firestore) · Google & Apple Sign-In · Real-time chat · Push notifications
